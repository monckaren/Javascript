//Lista de productos 
const prendas = [
{nombre:"Campera White", imagen: "ary-milligan-nLVyej-i2N4-unsplash", precio:"5800"},
{nombre: "Remera Black Slim Fit", imagen: "ian-dooley-1yl3jzKoKXg-unsplash", precio:"2300" },
{nombre: "Jean Slim Fit", imagen: "vladimir-fedotov-MPfyh3xJ1iE-unsplash", precio:"4800" },
{nombre: "Jean Holgado Claro ", imagen: "hans-isaacson-QJfXnkKrtlo-unsplash", precio:"5300" },
{nombre: "Jean Roto con Parches", imagen: "alicia-petresc-BciCcl8tjVU-unsplash", precio:"4300" },
{nombre: "Blazer Black", imagen: "joshua-rondeau-3_sGB2ON4X0-unsplash", precio:"4600" },
]
...
for (let prendaCargada of prendasCargadas) {
    ...
    contenido += " <div class=' col-md-4 py-4' style='width: 15rem;'>";
    ...
    contenido += "<h5 class='card-title col-md-6'>"+Ropa.nombre+"</h5>";
    contenido += "<div class='row mb-2'>";
    contenido += "<div class='col-md-6 card-text text-muted text-decoration-line-through'><span>$" +Ropa.precio+"</span></div>";
    contenido += "<div class=' card-text'><span>"+Ropa.aplicarDescuento()+"</span></div>";
    contenido += "</div>";
    contenido += "<button type='button' class='btn btn-dark btn-sm'>Agregar</button>";
    contenido += "</div>";
    contenido += "</div>";
